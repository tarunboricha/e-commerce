...
export class UserSerService {
  ...
  userSignupservice(data: signUp) {
    ...
    if (data.name != '' && data.email != '' && data.password != '') {
      this.htttp.post('https://af33-2409-4041-2d80-9c3-6d67-8196-d228-be3a.ngrok-free.app/users',
  ...
  UserLoginservice(data: Login) {
    this.htttp.get(`https://af33-2409-4041-2d80-9c3-6d67-8196-d228-be3a.ngrok-free.app/users/${data.email}/${data.password}`,
