...
export class UserSerService {
  ...
  userSignupservice(data: signUp) {
    ...
    if (data.name != '' && data.email != '' && data.password != '') {
      this.htttp.post('https://84e3-103-250-162-221.ngrok-free.app/users',
  ...
  UserLoginservice(data: Login) {
    this.htttp.get(`https://84e3-103-250-162-221.ngrok-free.app/users/${data.email}/${data.password}`,
